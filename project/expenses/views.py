...
def category_detail(request, slug):
  ...
  return render(request, 'expenses/category_detail.html', {'category': category, 'category_summary': category_summary, 'category_detail': category_detail, 'summary_count': summary_count, 'top_5_summaries': top_5_summaries})
